...
// let siteName = document.querySelector("#siteName") as HTMLInputElement;
// let siteURL = document.querySelector("#siteURL") as HTMLInputElement;

// const submitBtn = document.querySelector("button") as HTMLButtonElement;
// const tableData = document.querySelector("#tableData") as HTMLTableElement;
// const themeBtn = document.querySelector("#themeBtn i") as HTMLButtonElement;

// const addBookmarkBtn = document.querySelector("#addBtn") as HTMLButtonElement;

// let editBookmarkNo: number = 0;
// let mode: "create" | "edit" = "create";
// let currentTheme: string | "light" | "dark" = "dark";
// let bookmarks: { name: string; url: string; no: number }[] = [];
...
//   if (themeBtn) themeBtn.className = "fa-solid fa-sun";
// } else {
//   if (themeBtn) themeBtn.className = "fa-solid fa-moon";
// }
...
// function assignInputValues(index: number) {
//   const bookmark = {
...
//   if (siteName) siteName.value = bookmark.name;
//   if (siteURL) siteURL.value = bookmark.url;
//   editBookmarkNo = bookmark.no;

//   displayBookmarkForm("edit");
// }

// function updateBookmark(index: number) {
...
// function displayBookmarkForm(status: "create" | "edit"): void {
...
// function displayToast(text: "add" | "delete" | "edit") {
...
//   console.log(mode);
//   if (mode === "create") add();
//   else if (mode === "edit") updateBookmark(editBookmarkNo - 1);
// };
